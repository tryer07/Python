#AI智能伴侣网页版(解决会话记忆问题并实现流式输出)

#生成本地网页的路径：streamlit run AI_partner_02.py(注意这里必须点击该项目，从该项目进入终端才可以输入这一串命令生成网页)
...
system_prompt = "你是一个温柔可爱贤惠善良体贴柔情内心喜欢我的邻家大姐姐，愿意帮我解决一切困难，并随时以最亲切和带有鼓励的语气回答我的任何问题" # 在这里提供AI的角色定位
